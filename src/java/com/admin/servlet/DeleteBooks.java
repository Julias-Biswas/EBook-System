...
public class DeleteBooks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteBooks</title>");            
            out.println("</head>");
            out.println("<body>");
            */
            ...
            try
            {
                /*  Get All Data from All Books and Delete this Books  */
                int bookId = Integer.parseInt(request.getParameter("v"));
                String authorName = request.getParameter("start_radio");
                ...
                {
                    session.setAttribute("errMsg", "Book Deleted Failed...!!!");
                    response.sendRedirect("admin/all_books.jsp");
                }
