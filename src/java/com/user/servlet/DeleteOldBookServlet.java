...
public class DeleteOldBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteOldBookServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try
            {
                /*  Get All Data from See Old Books and Delete this Books  */
                ...
                boolean status = bookDaoClass.deleteBooks(bookId, authorName, bookCategory);
                ...
                {
                    session.setAttribute("errMsg", "Old Book Deleted Failed...!!!");
                    response.sendRedirect("see_old_books.jsp");
                }
