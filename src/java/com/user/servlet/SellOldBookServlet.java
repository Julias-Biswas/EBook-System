...
public class SellOldBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SellOldBookServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            */
            ...
            try
            {
                /*  Get All data from Sell Old Books Form  */
                ...
                if( status == true )
                {
                    ...
                    out.print("Old Book Added Successfully...");
                }
                else
                {
                    ...
                    out.print("Old Book Added Failed...");
                }
