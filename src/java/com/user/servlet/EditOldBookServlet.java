 ...
 * @author julia
 */
public class EditOldBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditOldBookServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try
            {
                /*  Get All data from Edit Old Books Form  */
                ...
                if( status == true )
                {
                    session.setAttribute("successMsg", "Old Book Updated Successfully...!!!");
                    response.sendRedirect("see_old_books.jsp");
                    
                    //out.print("Book Updated Successfully...");
                }
                else
                {
                    session.setAttribute("errMsg", "Old Book Updated Failed...!!!");
                    response.sendRedirect("see_old_books.jsp");
